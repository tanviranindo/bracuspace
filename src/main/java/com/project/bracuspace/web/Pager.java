package com.project.bracuspace.web;
...
public class Pager {
    ...
    public void setPageSizesToShow(long totalSize) {
        this.pageSizesToShow = Arrays.stream(PagingSize.PAGE_SIZES).boxed().filter(pageSize -> totalSize > pageSize).collect(Collectors.toList());
    }
}
